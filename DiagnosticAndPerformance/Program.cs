...
using System.Diagnostics; // namespace for accessing diagnostics and instrumentation, PerformanceCounter
using System.Linq;
using System.Text;

namespace DiagnosticsAndPerformance
{
    class Program
    {
        ...
        // when the application runs, these 5 methods run
        ...
        static Int64 Run(int num) // Run method, this is a for loop that goes from 0 to whatever number is passed-in
        { 
            Int64 x = 0;
            for (int i1 = 0; i1 < num; i1++) // these for loops are intended to burden the system
